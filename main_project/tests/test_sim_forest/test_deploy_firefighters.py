...
class TestForestFireGraphFirefighters(unittest.TestCase):
    ...
    # tests for deploy_firefighters method on ForestFireGraph
    def test_deploy_firefighters_list_len(self):
        """Check if correct number is added to list"""
        test = self.setUp_test_graph()

        result = len(test._firefighters_list)
        expected = 5
